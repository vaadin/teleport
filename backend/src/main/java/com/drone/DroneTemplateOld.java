...
public class DroneTemplateOld implements InitializingBean, DisposableBean {
    ...
    public DroneTemplateOld(AsyncTaskExecutor taskExecutor,
                         DroneStateChangeCallback... callbacks) throws UnknownHostException {
        this(null, DEFAULT_COMMAND_FPS, taskExecutor, callbacks);
    }

    public DroneTemplateOld(DroneStateChangeCallback... callbacks)
            throws UnknownHostException {
        this(new SimpleAsyncTaskExecutor(), callbacks);
    }

    public DroneTemplateOld(String ip, int fps, AsyncTaskExecutor taskExecutor,
                         DroneStateChangeCallback... callbacks) throws UnknownHostException {
